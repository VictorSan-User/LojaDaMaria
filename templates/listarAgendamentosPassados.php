...
<head>
  <meta charset="UTF-8" />
  <title>Agendamentos Passados</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" />
</head>
<body class="bg-light">
  <div class="container py-5">
    <h1 class="mb-4 text-center">Agendamentos Passados</h1>

    <div id="lista-passados" class="d-flex flex-column align-items-center"></div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      fetch('../Controllers/ControllerListagemPassados.php')
        .then(res => {
        ...
        .then(data => {
          container.innerHTML = '';
          if (data.length === 0) {
            container.innerHTML = '<p>Nenhum agendamento passado encontrado.</p>';
            return;
          }
          data.forEach(item => {
